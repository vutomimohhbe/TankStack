...
const Chatbot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      text: "Hi! I'm TankBot, your virtual assistant. How can I help you learn about TankStank's services today?",
      isUser: false,
      timestamp: new Date()
    }
  ]);
  ...
  const getBotResponse = (userMessage: string): string => {
    ...
    if (message.includes('hello') || message.includes('hi') || message.includes('hey')) {
      return "Hello! Welcome to TankStank. I'm here to help you learn about our technology solutions. What would you like to know?";
    }
    ...
    if (message.includes('ai') || message.includes('automation') || message.includes('artificial intelligence')) {
    ...
    if (message.includes('team') || message.includes('who are you')) {
      return "TankStank has 4 expert team members: Alex (CTO), Sarah (Cybersecurity Specialist), Marcus (Systems Integration Lead), and Emily (AI & Automation Consultant). Each brings unique skills to solve your tech challenges.";
    }
    
    if (message.includes('contact') || message.includes('reach') || message.includes('talk')) {
      return "You can reach us through our contact form below, email us at hello@tankstank.com, or call us at (555) 123-TANK. We'd love to discuss how we can help your business!";
    }
        ...
        <div className="fixed bottom-24 right-6 z-50 w-80 sm:w-96 bg-white rounded-lg shadow-2xl border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-teal-600 text-white p-4 flex items-center">
            ...
            <div>
              ...
              <div className="text-xs opacity-90">Online • Ask me anything!</div>
            </div>
          </div>
