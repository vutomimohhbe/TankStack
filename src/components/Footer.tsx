      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 leading-relaxed">
              Modern tech solutions for growing businesses. We solve your technology challenges 
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><span className="text-gray-400">System Integration</span></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © {currentYear} TankStank. All rights reserved. Built with passion for technology and innovation.
          </p>
        </div>
      </div>
    </footer>
